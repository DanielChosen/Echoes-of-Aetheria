...
public class Act2Scene8KnightCombat2 extends Scene {

    Act2TheKnight act2TheKnight;

    public Act2Scene8KnightCombat2(String title, Player player, UI ui, Act2TheKnight act2TheKnight) {
    ...
    protected void onVictory() {
        ...
        act2TheKnight.gotoNextScene(() -> act2TheKnight.scene_KnightBattleVictory());
    }
