...
public class Act1IntroScenes {
    ...
    public void scene_theCrystal() {
        ui.mainTextArea.setText("Exhausted from training, the young man lay beneath a swaying oak tree. The breeze cooled his skin, carrying the scent of fresh bread and pine.\n" + //
                        "\n" + //
    ...
    public void scene_theBeginningOfAJourney() {
        ui.mainTextArea.setText("He walked the main road for days. Ahead, shrieks echoed. A girl in white, shimmering faintly, was surrounded by monsters.\n" + //
                        "\n" + //
                        "The chaos of the moment pressed on him; the urgency was clear, and he had to act.");
        ui.choice1.setText("Save her"); ui.choice1.setActionCommand("saveHerOutcome");
