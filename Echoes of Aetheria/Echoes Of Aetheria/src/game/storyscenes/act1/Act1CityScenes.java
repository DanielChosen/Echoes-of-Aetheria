...
public class Act1CityScenes {
    ...
    public void city_BlackSmith() {
        ui.mainTextArea.setText("The rhythmic clang of hammer on metal fills the air. Behind the counter, a burly man pauses his work and wipes soot from his face.\n" + //
                        "\n" + //
    ...
    public void city_MageShop() {
        ui.mainTextArea.setText("You step into a small shop, filled with the scent of herbs and faintly glowing crystals. A mage peers over the counter, eyes sharp and curious.\n" + //
                        "\n" + //
